...
#End Region
    ...
    End Sub
    Public Sub GetAcDetails(ByVal acc As Integer)
        ...
        Try
            ...
            AcName = ds.Tables(0).Rows(0).Item(1).ToString() + " " + ds.Tables(0).Rows(0).Item(2).ToString()
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If name = AcName Then
            Dim pin_test As FrontATM_PinTest1
            pin_test = New FrontATM_PinTest1(acc_no)
            Me.Dispose()
            Timer1.Stop()
            Timer1.Dispose()
            Me.Close()
